...
export function GetLanguages200ResponseInnerFromJSON(
  json: any,
): GetLanguages200ResponseInner {
  return GetLanguages200ResponseInnerFromJSONTyped(json, false)
}

export function GetLanguages200ResponseInnerFromJSONTyped(
  json: any,
  ...
  return {
    ...
    name: json['name'],
    supportsFormality: !exists(json, 'supports_formality')
      ? undefined
      : json['supports_formality'],
  }
}

export function GetLanguages200ResponseInnerToJSON(
  value?: GetLanguages200ResponseInner | null,
): any {
  if (value === undefined) {
    return undefined
  }
