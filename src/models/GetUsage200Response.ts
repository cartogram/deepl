...
export function GetUsage200ResponseFromJSONTyped(
  json: any,
  ...
  return {
    characterCount: !exists(json, 'character_count')
      ? undefined
      : json['character_count'],
    characterLimit: !exists(json, 'character_limit')
      ? undefined
      : json['character_limit'],
    documentLimit: !exists(json, 'document_limit')
      ? undefined
      : json['document_limit'],
    documentCount: !exists(json, 'document_count')
      ? undefined
      : json['document_count'],
    teamDocumentLimit: !exists(json, 'team_document_limit')
      ? undefined
      : json['team_document_limit'],
    teamDocumentCount: !exists(json, 'team_document_count')
      ? undefined
      : json['team_document_count'],
  }
}

export function GetUsage200ResponseToJSON(
  value?: GetUsage200Response | null,
): any {
  if (value === undefined) {
    return undefined
  }
