...
export function GlossaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): Glossary {
    ...
    return {
        ...
        'sourceLang': !exists(json, 'source_lang') ? undefined : GlossarySourceLanguageFromJSON(json['source_lang']),
        'targetLang': !exists(json, 'target_lang') ? undefined : GlossaryTargetLanguageFromJSON(json['target_lang']),
        'creationTime': !exists(json, 'creation_time') ? undefined : (new Date(json['creation_time'])),
...
export function GlossaryToJSON(value?: Glossary | null): any {
    ...
    return {
        ...
        'creation_time': value.creationTime === undefined ? undefined : (value.creationTime.toISOString()),
