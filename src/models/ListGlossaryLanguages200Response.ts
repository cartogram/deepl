 ...
 */
export function instanceOfListGlossaryLanguages200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ListGlossaryLanguages200ResponseFromJSON(json: any): ListGlossaryLanguages200Response {
    return ListGlossaryLanguages200ResponseFromJSONTyped(json, false);
}

export function ListGlossaryLanguages200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListGlossaryLanguages200Response {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'supportedLanguages': !exists(json, 'supported_languages') ? undefined : ((json['supported_languages'] as Array<any>).map(ListGlossaryLanguages200ResponseSupportedLanguagesInnerFromJSON)),
    };
}

export function ListGlossaryLanguages200ResponseToJSON(value?: ListGlossaryLanguages200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'supported_languages': value.supportedLanguages === undefined ? undefined : ((value.supportedLanguages as Array<any>).map(ListGlossaryLanguages200ResponseSupportedLanguagesInnerToJSON)),
    };
}
