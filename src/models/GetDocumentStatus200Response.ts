...
export type GetDocumentStatus200ResponseStatusEnum =
  (typeof GetDocumentStatus200ResponseStatusEnum)[keyof typeof GetDocumentStatus200ResponseStatusEnum]
...
export function GetDocumentStatus200ResponseFromJSON(
  json: any,
): GetDocumentStatus200Response {
  return GetDocumentStatus200ResponseFromJSONTyped(json, false)
}

export function GetDocumentStatus200ResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    status: json['status'],
    secondsRemaining: !exists(json, 'seconds_remaining')
      ? undefined
      : json['seconds_remaining'],
    billedCharacters: !exists(json, 'billed_characters')
      ? undefined
      : json['billed_characters'],
    errorMessage: !exists(json, 'error_message')
      ? undefined
      : json['error_message'],
  }
}

export function GetDocumentStatus200ResponseToJSON(
  value?: GetDocumentStatus200Response | null,
): any {
  if (value === undefined) {
    return undefined
  }
