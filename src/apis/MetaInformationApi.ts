...
export class MetaInformationApi extends runtime.BaseAPI {
     ...
     */
    async getLanguagesRaw(requestParameters: GetLanguagesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<GetLanguages200ResponseInner>>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(GetLanguages200ResponseInnerFromJSON));
    }
     ...
     * Retrieve Supported Languages
     */
    async getLanguages(requestParameters: GetLanguagesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<GetLanguages200ResponseInner>> {
     ...
     */
    async getUsageRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetUsage200Response>> {
        const queryParameters: any = {};
     ...
     * Check Usage and Limits
     */
    async getUsage(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetUsage200Response> {
...
export type GetLanguagesTypeEnum = typeof GetLanguagesTypeEnum[keyof typeof GetLanguagesTypeEnum];
