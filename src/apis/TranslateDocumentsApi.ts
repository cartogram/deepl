...
export class TranslateDocumentsApi extends runtime.BaseAPI {
  ...
  async downloadDocumentRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'documentId',
        'Required parameter requestParameters.documentId was null or undefined when calling downloadDocument.',
      )
    }

    if (
      requestParameters.getDocumentStatusRequest === null ||
      requestParameters.getDocumentStatusRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'getDocumentStatusRequest',
        'Required parameter requestParameters.getDocumentStatusRequest was null or undefined when calling downloadDocument.',
      )
    }
    ...
    const response = await this.request(
      {
        path: `/document/{document_id}/result`.replace(
          `{${'document_id'}}`,
        ...
        body: GetDocumentStatusRequestToJSON(
          requestParameters.getDocumentStatusRequest,
        ),
      },
      initOverrides,
    )
   ...
   */
  async getDocumentStatusRaw(
    requestParameters: GetDocumentStatusOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<GetDocumentStatus200Response>> {
    if (
      requestParameters.documentId === null ||
      requestParameters.documentId === undefined
    ) {
      throw new runtime.RequiredError(
        'documentId',
        'Required parameter requestParameters.documentId was null or undefined when calling getDocumentStatus.',
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'getDocumentStatusRequest',
        'Required parameter requestParameters.getDocumentStatusRequest was null or undefined when calling getDocumentStatus.',
      )
    }
    ...
    const response = await this.request(
      {
        path: `/document/{document_id}`.replace(
          `{${'document_id'}}`,
          encodeURIComponent(String(requestParameters.documentId)),
        ),
        method: 'POST',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      GetDocumentStatus200ResponseFromJSON(jsonValue),
    )
  }
  ...
  async getDocumentStatus(
    requestParameters: GetDocumentStatusOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<GetDocumentStatus200Response> {
    const response = await this.getDocumentStatusRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
   ...
   */
  async translateDocumentRaw(
    requestParameters: TranslateDocumentRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<TranslateDocument200Response>> {
    if (
      ...
      throw new runtime.RequiredError(
        'targetLang',
        'Required parameter requestParameters.targetLang was null or undefined when calling translateDocument.',
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'file',
        'Required parameter requestParameters.file was null or undefined when calling translateDocument.',
      )
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      TranslateDocument200ResponseFromJSON(jsonValue),
    )
  }
  ...
  async translateDocument(
    requestParameters: TranslateDocumentRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<TranslateDocument200Response> {
    const response = await this.translateDocumentRaw(
      requestParameters,
      initOverrides,
    )
    return await response.value()
