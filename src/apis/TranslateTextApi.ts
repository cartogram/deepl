...
export class TranslateTextApi extends runtime.BaseAPI {
     ...
     * Request Translation
     */
    async translateTextRaw(requestParameters: TranslateTextRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TranslateText200Response>> {
        if (requestParameters.text === null || requestParameters.text === undefined) {
            throw new runtime.RequiredError('text','Required parameter requestParameters.text was null or undefined when calling translateText.');
        }

        if (requestParameters.targetLang === null || requestParameters.targetLang === undefined) {
            throw new runtime.RequiredError('targetLang','Required parameter requestParameters.targetLang was null or undefined when calling translateText.');
        }
        ...
        if (requestParameters.splitSentences !== undefined) {
            formParams.append('split_sentences', requestParameters.splitSentences as any);
        }

        if (requestParameters.preserveFormatting !== undefined) {
            formParams.append('preserve_formatting', requestParameters.preserveFormatting as any);
        }
        ...
        if (requestParameters.nonSplittingTags !== undefined) {
            formParams.append('non_splitting_tags', requestParameters.nonSplittingTags as any);
        }

        if (requestParameters.outlineDetection !== undefined) {
            formParams.append('outline_detection', requestParameters.outlineDetection as any);
        }

        if (requestParameters.splittingTags !== undefined) {
            formParams.append('splitting_tags', requestParameters.splittingTags as any);
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => TranslateText200ResponseFromJSON(jsonValue));
    }
     ...
     * Request Translation
     */
    async translateText(requestParameters: TranslateTextRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TranslateText200Response> {
...
export type TranslateTextSplitSentencesEnum = typeof TranslateTextSplitSentencesEnum[keyof typeof TranslateTextSplitSentencesEnum];
/**
 * @export
 */
...
export type TranslateTextPreserveFormattingEnum = typeof TranslateTextPreserveFormattingEnum[keyof typeof TranslateTextPreserveFormattingEnum];
/**
 * @export
 */
...
export type TranslateTextTagHandlingEnum = typeof TranslateTextTagHandlingEnum[keyof typeof TranslateTextTagHandlingEnum];
/**
 * @export
 */
...
export type TranslateTextOutlineDetectionEnum = typeof TranslateTextOutlineDetectionEnum[keyof typeof TranslateTextOutlineDetectionEnum];
