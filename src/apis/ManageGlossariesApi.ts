...
export class ManageGlossariesApi extends runtime.BaseAPI {
   ...
   * Create a Glossary
   */
  async createGlossaryRaw(
    requestParameters: CreateGlossaryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Glossary>> {
    if (
      ...
      throw new runtime.RequiredError(
        'name',
        'Required parameter requestParameters.name was null or undefined when calling createGlossary.',
      )
    }

    if (
      requestParameters.sourceLang === null ||
      requestParameters.sourceLang === undefined
    ) {
      throw new runtime.RequiredError(
        'sourceLang',
        'Required parameter requestParameters.sourceLang was null or undefined when calling createGlossary.',
      )
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'targetLang',
        'Required parameter requestParameters.targetLang was null or undefined when calling createGlossary.',
      )
    }

    if (
      requestParameters.entries === null ||
      requestParameters.entries === undefined
    ) {
      throw new runtime.RequiredError(
        'entries',
        'Required parameter requestParameters.entries was null or undefined when calling createGlossary.',
      )
    }

    if (
      requestParameters.entriesFormat === null ||
      requestParameters.entriesFormat === undefined
    ) {
      throw new runtime.RequiredError(
        'entriesFormat',
        'Required parameter requestParameters.entriesFormat was null or undefined when calling createGlossary.',
      )
    }
    ...
    if (requestParameters.entriesFormat !== undefined) {
      formParams.append(
        'entries_format',
        requestParameters.entriesFormat as any,
      )
    }
  ...
  async createGlossary(
    ...
    const response = await this.createGlossaryRaw(
      requestParameters,
      initOverrides,
    )
   ...
   * Delete a Glossary
   */
  async deleteGlossaryRaw(
    requestParameters: DeleteGlossaryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters.glossaryId === null ||
      requestParameters.glossaryId === undefined
    ) {
      throw new runtime.RequiredError(
        'glossaryId',
        'Required parameter requestParameters.glossaryId was null or undefined when calling deleteGlossary.',
      )
    }
    ...
    const response = await this.request(
      {
        path: `/glossaries/{glossary_id}`.replace(
          `{${'glossary_id'}}`,
          encodeURIComponent(String(requestParameters.glossaryId)),
        ),
        method: 'DELETE',
        headers: headerParameters,
        query: queryParameters,
   ...
   */
  async getGlossaryRaw(
    requestParameters: GetGlossaryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Glossary>> {
    if (
      requestParameters.glossaryId === null ||
      ...
      throw new runtime.RequiredError(
        'glossaryId',
        'Required parameter requestParameters.glossaryId was null or undefined when calling getGlossary.',
      )
    }
   ...
   */
  async getGlossaryEntriesRaw(
    requestParameters: GetGlossaryEntriesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (
      requestParameters.glossaryId === null ||
      ...
      throw new runtime.RequiredError(
        'glossaryId',
        'Required parameter requestParameters.glossaryId was null or undefined when calling getGlossaryEntries.',
      )
    }
    ...
    const response = await this.request(
      {
        path: `/glossaries/{glossary_id}/entries`.replace(
          `{${'glossary_id'}}`,
          encodeURIComponent(String(requestParameters.glossaryId)),
        ),
        method: 'GET',
   ...
   * List all Glossaries
   */
  async listGlossariesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ListGlossaries200Response>> {
    const queryParameters: any = {}
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ListGlossaries200ResponseFromJSON(jsonValue),
    )
  }
  ...
  async listGlossaries(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ListGlossaries200Response> {
   ...
   */
  async listGlossaryLanguagesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ListGlossaryLanguages200Response>> {
    const queryParameters: any = {}
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ListGlossaryLanguages200ResponseFromJSON(jsonValue),
    )
  }
   ...
   * List Language Pairs Supported by Glossaries
   */
  async listGlossaryLanguages(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ListGlossaryLanguages200Response> {
...
export type CreateGlossaryEntriesFormatEnum =
  (typeof CreateGlossaryEntriesFormatEnum)[keyof typeof CreateGlossaryEntriesFormatEnum]
/**
 * @export
 */
...
export type GetGlossaryEntriesAcceptEnum =
  (typeof GetGlossaryEntriesAcceptEnum)[keyof typeof GetGlossaryEntriesAcceptEnum]
